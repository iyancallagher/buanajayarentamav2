...
// Ambil detail riwayat penerimaan barang
$sql = "SELECT m.id as masuk_id, m.quantity as qty_masuk,
...
if (!$data) {
    $_SESSION['form_error'] = "Data riwayat transaksi penerimaan tidak ditemukan.";
    header("Location: ../sparepart-masuk.php");
    exit;
}
...
<main class="p-6 bg-slate-50 min-h-screen">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-800">Manajemen Sparepart Masuk</h1>
        </div>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-6 border-b border-slate-200">
                <h2 class="font-semibold text-lg text-slate-800">Koreksi Kuantitas Masuk</h2>
                <p class="text-sm text-slate-500 mt-1">Ubah kuantitas item pada riwayat penerimaan ini secara langsung.</p>
            </div>

            <form action="update-sparepart-masuk.php" method="POST" class="p-6 space-y-5">
                <input type="hidden" name="masuk_id" value="<?= $data['masuk_id'] ?>">

                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Jumlah Masuk Baru</label>
                    <div class="relative">
                ...
                <div class="flex items-center gap-3 pt-4">
                    ...
                    <a href="../sparepart-masuk.php" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-semibold hover:bg-slate-50 transition-all duration-200">
                        Batal
                    </a>
                </div>
            </form>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600 leading-relaxed">
                            Fitur ini hanya mengubah catatan angka kuantitas pada log riwayat penerimaan warehouse. Aksi ini <strong>tidak akan memotong ataupun menambahkan kembali</strong> jumlah stok fisik utama.
                        </p>
                    </div>
                </div>
            </div>
