...
// Tambahkan parameter skor kecocokan teks jika sedang mencari
$relevanceSelect = "";
...
if (!empty($booleanQuery)) {
    ...
    // Sisipkan parameter booleanQuery di urutan pertama array ($params) karena diletakkan di klausa SELECT
